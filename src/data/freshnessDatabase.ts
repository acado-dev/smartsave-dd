...
const fruits: Omit<FreshnessItem, "band">[] = [
  ...
  { id: "FR064", name: "Pomegranate", category: "fruits", subcategory: "Tropical", sku: "POM-FRE-064", supplier: "Exotic Produce Ltd.", quantity: 55, unit: "whole", originalPrice: 3.99, cost: 2.00, location: "Produce Section C", receivedDate: daysAgo(2), expiryDate: daysFromNow(10), clearanceDate: daysFromNow(7), freshnessScore: 65, optimal_temp: "41-45°F", keywords: ["pomegranate", "pome", "red", "round", "seeds", "arils", "fruit"], clearanceDiscount: 10 },
