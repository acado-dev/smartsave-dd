...
const fruits: Omit<FreshnessItem, "band">[] = [
  ...
  { id: "FR001", name: "Overripe Bananas", category: "fruits", subcategory: "Tropical", sku: "BAN-OVR-001", supplier: "Fresh Farms Co.", quantity: 18, unit: "lbs", originalPrice: 0.89, cost: 0.45, location: "Clearance Bin A", receivedDate: daysAgo(9), expiryDate: daysFromNow(0), clearanceDate: daysAgo(3), freshnessScore: 23, optimal_temp: "58-60°F", keywords: ["banana", "overripe", "brown", "spotty", "mushy", "fruit"], clearanceDiscount: 80 },
  ...
  { id: "FR014", name: "Spoiled Pomegranate", category: "fruits", subcategory: "Tropical", sku: "POM-SPO-014", supplier: "Exotic Produce Ltd.", quantity: 12, unit: "whole", originalPrice: 3.99, cost: 2.00, location: "Clearance Bin A", receivedDate: daysAgo(10), expiryDate: daysFromNow(0), clearanceDate: daysAgo(4), freshnessScore: 15, optimal_temp: "41-45°F", keywords: ["pomegranate", "pome", "spoiled", "seeds", "fruit"], clearanceDiscount: 85 },
  ...
  { id: "FR024", name: "Aged Pomegranate", category: "fruits", subcategory: "Tropical", sku: "POM-AGE-024", supplier: "Exotic Produce Ltd.", quantity: 20, unit: "whole", originalPrice: 3.99, cost: 2.00, location: "Clearance Bin B", receivedDate: daysAgo(8), expiryDate: daysFromNow(1), clearanceDate: daysFromNow(0), freshnessScore: 24, optimal_temp: "41-45°F", keywords: ["pomegranate", "pome", "aged", "seeds", "fruit"], clearanceDiscount: 65 },
  ...
  // ── 91–100% ────────────────────────────────────────────────────────────
  { id: "FR091", name: "Premium Bananas", category: "fruits", subcategory: "Tropical", sku: "BAN-PRE-091", supplier: "Fresh Farms Co.", quantity: 45, unit: "lbs", originalPrice: 1.29, cost: 0.60, location: "Produce Section A", receivedDate: daysFromNow(0), expiryDate: daysFromNow(7), clearanceDate: daysFromNow(6), freshnessScore: 94, optimal_temp: "58-60°F", keywords: ["banana", "yellow", "fresh", "premium", "tropical"], clearanceDiscount: 0 },
  { id: "FR085", name: "Fresh Bananas", category: "fruits", subcategory: "Tropical", sku: "BAN-FRE-085", supplier: "Fresh Farms Co.", quantity: 60, unit: "lbs", originalPrice: 0.99, cost: 0.45, location: "Produce Section A", receivedDate: daysAgo(1), expiryDate: daysFromNow(6), clearanceDate: daysFromNow(5), freshnessScore: 85, optimal_temp: "58-60°F", keywords: ["banana", "yellow", "fresh", "fruit", "tropical"], clearanceDiscount: 5 },
  { id: "FR076", name: "Ripe Bananas", category: "fruits", subcategory: "Tropical", sku: "BAN-RIP-076", supplier: "Fresh Farms Co.", quantity: 85, unit: "lbs", originalPrice: 0.89, cost: 0.40, location: "Produce Section A", receivedDate: daysAgo(2), expiryDate: daysFromNow(5), clearanceDate: daysFromNow(4), freshnessScore: 75, optimal_temp: "58-60°F", keywords: ["banana", "yellow", "ripe", "fruit", "tropical"], clearanceDiscount: 10 },
  { id: "FR065", name: "Yellow Bananas (Firm)", category: "fruits", subcategory: "Tropical", sku: "BAN-FRM-065", supplier: "Fresh Farms Co.", quantity: 120, unit: "lbs", originalPrice: 0.89, cost: 0.40, location: "Produce Section A", receivedDate: daysAgo(2), expiryDate: daysFromNow(6), clearanceDate: daysFromNow(5), freshnessScore: 65, optimal_temp: "58-60°F", keywords: ["banana", "yellow", "firm", "fruit", "tropical"], clearanceDiscount: 15 },
  { id: "FR054", name: "Yellow Bananas", category: "fruits", subcategory: "Tropical", sku: "BAN-YEL-054", supplier: "Fresh Farms Co.", quantity: 140, unit: "lbs", originalPrice: 0.89, cost: 0.40, location: "Produce Section A", receivedDate: daysAgo(3), expiryDate: daysFromNow(5), clearanceDate: daysFromNow(4), freshnessScore: 55, optimal_temp: "58-60°F", keywords: ["banana", "yellow", "fruit", "tropical"], clearanceDiscount: 20 },
...
const vegetables: Omit<FreshnessItem, "band">[] = [
  ...
  { id: "VG034", name: "Potatoes (Old Stock)", category: "vegetables", subcategory: "Root", sku: "POT-OLD-034", supplier: "Root Vegetable Co.", quantity: 180, unit: "lbs", originalPrice: 0.99, cost: 0.40, location: "Produce Section E", receivedDate: daysAgo(10), expiryDate: daysFromNow(3), clearanceDate: daysFromNow(1), freshnessScore: 31, optimal_temp: "45-50°F", keywords: ["potato", "brown", "old", "root", "vegetable"], clearanceDiscount: 45 },
  ...
  // ── 91–100% ────────────────────────────────────────────────────────────
  { id: "VG091", name: "Premium Tomatoes", category: "vegetables", subcategory: "Salad", sku: "TOM-PRE-091", supplier: "Garden Fresh Ltd.", quantity: 50, unit: "lbs", originalPrice: 3.49, cost: 1.70, location: "Produce Section D", receivedDate: daysFromNow(0), expiryDate: daysFromNow(8), clearanceDate: daysFromNow(7), freshnessScore: 95, optimal_temp: "55-70°F", keywords: ["tomato", "red", "fresh", "premium", "vegetable"], clearanceDiscount: 0 },
  { id: "VG085", name: "Fresh Tomatoes", category: "vegetables", subcategory: "Salad", sku: "TOM-FRE-085", supplier: "Garden Fresh Ltd.", quantity: 75, unit: "lbs", originalPrice: 2.99, cost: 1.50, location: "Produce Section D", receivedDate: daysAgo(1), expiryDate: daysFromNow(7), clearanceDate: daysFromNow(6), freshnessScore: 86, optimal_temp: "55-70°F", keywords: ["tomato", "red", "fresh", "vegetable", "salad"], clearanceDiscount: 5 },
  { id: "VG075", name: "Ripe Tomatoes", category: "vegetables", subcategory: "Salad", sku: "TOM-RIP-075", supplier: "Garden Fresh Ltd.", quantity: 100, unit: "lbs", originalPrice: 2.49, cost: 1.25, location: "Produce Section D", receivedDate: daysAgo(2), expiryDate: daysFromNow(6), clearanceDate: daysFromNow(5), freshnessScore: 76, optimal_temp: "55-70°F", keywords: ["tomato", "red", "ripe", "vegetable", "salad"], clearanceDiscount: 10 },
...
/** 
 * Returns a simplified list of produce types with their primary keywords 
 * for AI context mapping.
 */
export function getAIProduceList(): string {
  const allItems = [...fruits, ...vegetables];
  const uniqueProduce = new Map<string, { kws: Set<string>, category: string, subcategory: string }>();

  allItems.forEach(item => {
    const words = item.name.split(' ');
    const baseName = words[words.length - 1];

    if (!uniqueProduce.has(baseName)) {
      uniqueProduce.set(baseName, {
        kws: new Set(item.keywords),
        category: item.category,
        subcategory: item.subcategory
      });
    } else {
      const entry = uniqueProduce.get(baseName);
      if (entry) {
        item.keywords.forEach(k => entry.kws.add(k));
      }
    }
  });

  return Array.from(uniqueProduce.entries())
    .map(([name, data]) => `${name} (${data.category} - ${data.subcategory}): [${Array.from(data.kws).join(', ')}]`)
    .join('\n');
}
