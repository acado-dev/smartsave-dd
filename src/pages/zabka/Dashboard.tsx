    ...
    <div className="p-6 space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Stores with actions requiring attention</CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <Card key={idx} className="border-2 border-dashed">
                <CardHeader className="pb-2">
                  <div className="flex items-center justify-between">
                    <div>
                      <CardTitle className="text-base">Store {store.store}</CardTitle>
                      <CardDescription className="text-xs">{store.location}</CardDescription>
                    </div>
                    <Badge variant={store.pendingActions > 5 ? "destructive" : "secondary"}>
                      {store.pendingActions} pending
                    </Badge>
                  </div>
                </CardHeader>
                <CardContent className="space-y-2">
                  {store.items.map((item, itemIdx) => (
                    <div key={itemIdx} className="flex justify-between items-center text-sm p-2 bg-muted/50 rounded">
                      <div>
