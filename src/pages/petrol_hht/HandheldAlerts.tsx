...
const alerts = [
  {
    ...
    time: "5 min ago",
    icon: Battery,
    route: "/petrol_hht/health?filter=critical",
    read: false
  },
  {
    id: 2,
    ...
    time: "15 min ago",
    icon: XCircle,
    route: "/petrol_hht/jobs?filter=failed",
    read: false
  },
  {
    id: 3,
    ...
    time: "32 min ago",
    icon: Wifi,
    route: "/petrol_hht/operations/assign",
    read: false
  },
  {
    id: 4,
    ...
    <div className="p-4 space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Button variant="ghost" size="icon" onClick={() => navigate("/petrol_hht")}>
