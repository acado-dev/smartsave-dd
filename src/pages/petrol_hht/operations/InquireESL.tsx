      ...
      {eslDetails && (
        <>
          ...
          <div className="grid grid-cols-2 gap-2">
            <Button variant="outline" onClick={() => navigate(`/petrol_hht/operations/refresh?esl=${eslDetails.id}`)}>
              <RefreshCw className="h-4 w-4 mr-2" />
              Refresh
            </Button>
            <Button variant="outline" onClick={() => navigate(`/petrol_hht/operations/flash?esl=${eslDetails.id}`)}>
