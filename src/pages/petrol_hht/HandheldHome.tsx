...
const priorityActions = [
  {
    ...
    severity: "critical",
    action: "Fix Now",
    route: "/petrol_hht/home/health?filter=critical"
  },
  {
    id: 2,
    ...
    severity: "warning",
    action: "Retry",
    route: "/petrol_hht/home/jobs?filter=failed"
  },
  {
    id: 3,
...
const healthMetrics = [
  { label: "Online", value: 2847, total: 2891, icon: Wifi, color: "text-emerald-500", route: "/petrol_hht/home/status/online" },
  { label: "Offline", value: 44, total: 2891, icon: WifiOff, color: "text-orange-500", route: "/petrol_hht/home/status/offline" },
  { label: "Low Battery", value: 67, total: 2891, icon: Battery, color: "text-amber-500", route: "/petrol_hht/home/status/low-battery" },
];
  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 space-y-4 md:space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
        ...
        {/* Job Status Summary */}
        <Card className="cursor-pointer hover:shadow-md transition-all border-slate-200" onClick={() => navigate("/petrol_hht/home/jobs")}>
          <CardHeader className="pb-2 md:pb-4">
      ...
      <Card className="border-slate-200">
        ...
        <CardContent>
          <div className="grid grid-cols-4 md:grid-cols-4 lg:grid-cols-8 gap-2 md:gap-3">
            {[
              { icon: Cpu, label: "Assign", route: "/petrol_hht/home/operations/assign" },
              { icon: RefreshCw, label: "Refresh", route: "/petrol_hht/home/operations/refresh" },
              { icon: Battery, label: "Battery", route: "/petrol_hht/home/health" },
              { icon: AlertTriangle, label: "Issues", route: "/petrol_hht/home/jobs?filter=failed" },
            ].map((item) => (
              <Button
                key={item.label}
                variant="outline"
