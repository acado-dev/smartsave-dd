      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground flex items-center gap-1 mt-1">
              ...
              <span className="text-green-500">12% less</span> vs last week
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground flex items-center gap-1 mt-1">
              <TrendingDown className="h-3 w-3 text-green-500" />
              <span className="text-green-500">8% less</span> vs last week
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground flex items-center gap-1 mt-1">
              <TrendingDown className="h-3 w-3 text-green-500" />
              <span className="text-green-500">15% less</span> vs last week
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground flex items-center gap-1 mt-1">
              ...
              <span className="text-green-500">22% more</span> vs last week
            </p>
          </CardContent>
        </Card>
      </div>
                        ...
                        <div className="flex items-center gap-2">
                          {stat.trend < 0 ? (
                            <>
                              ...
                              <span className="text-green-500">{Math.abs(stat.trend)}% ↓</span>
                            </>
                          ) : (
                            <>
