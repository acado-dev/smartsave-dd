...
export default function Petrol2311Dashboard() {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex justify-between items-start">
        <div>
          <h1 className="text-3xl font-bold text-foreground">Petrol Station #2311 — Ljubljana Celovska 226</h1>
          <p className="text-muted-foreground mt-1">Comprehensive Food Waste Management & Operations</p>
        </div>
        <Button onClick={() => navigate('/petrol2311/analytics')}>
          Today's Report
        </Button>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard
          ...
          icon={Trash2}
          onClick={() => navigate('/petrol2311/waste-tracking')}
        />
        <StatCard
          ...
          icon={AlertTriangle}
          onClick={() => navigate('/petrol2311/expiring-items')}
        />
        <StatCard
          ...
          icon={Heart}
          onClick={() => navigate('/petrol2311/donations')}
        />
        <StatCard
          ...
          icon={TrendingDown}
          onClick={() => navigate('/petrol2311/low-salability')}
        />
      </div>
      ...
      <Card>
        <CardHeader>
          <div className="flex justify-between items-center">
            ...
            <Button variant="outline" size="sm" onClick={() => navigate('/petrol2311/expiring-items')}>
              View All
            </Button>
          </div>
        </CardHeader>
            ...
            {[
              ...
              <div key={idx} className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <Button size="sm" onClick={() => navigate('/petrol2311/dynamic-pricing')}>
                    Apply Pricing
                  </Button>
                </div>
              </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <Button className="w-full mt-2" size="sm" onClick={() => navigate('/petrol2311/discounts')}>
              Apply Discounts
            </Button>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <Button className="w-full mt-2" size="sm" onClick={() => navigate('/petrol2311/donations')}>
              Schedule Pickup
            </Button>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <Button className="w-full mt-2" size="sm" variant="outline" onClick={() => navigate('/petrol2311/low-salability')}>
              View Analysis
            </Button>
          </CardContent>
        </Card>
