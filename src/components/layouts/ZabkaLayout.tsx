...
import { ZabkaSidebar } from "@/components/navigation/ZabkaSidebar";
import { Menu } from "lucide-react";
import zabkaLogo from "@/assets/zabka-logo.png";
import displayDataLogo from "@/assets/displaydata-logo.png";

interface ZabkaLayoutProps {
  children: React.ReactNode;
}

export function ZabkaLayout({ children }: ZabkaLayoutProps) {
  return (
    <SidebarProvider>
            ...
            <div className="flex h-full items-center justify-between px-4">
              ...
              <div className="flex items-center gap-4">
                <div className="flex flex-col items-start">
                  <span className="text-sm font-semibold text-foreground">Convenience Store Management</span>
